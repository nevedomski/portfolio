...
// Newsletter component temporarily disabled
function Newsletter() {
  return (
    <form
      action="/thank-you"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Hi, I&apos;m {process.env.NEXT_PUBLIC_AUTHOR_NAME?.split(' ')[0]} — a {process.env.NEXT_PUBLIC_TITLE}. I love turning research ideas into practical machine learning systems and giving back through open-source. Right now, my focus is on building smarter Named Entity Recognition models and making them more flexible and developer-friendly.
          </p>
